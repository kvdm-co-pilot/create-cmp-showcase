...
[![Verify lane FAIL](https://img.shields.io/badge/evidence-lane_FAIL-E53935)](https://github.com/kvdm-co-pilot/create-cmp) — the last lane run at `8c7b64f` on 2026-08-23 did not pass. No rung is earned by a failed lane. The tree had 24 uncommitted files at attestation, so this describes that run, not that commit.
<!-- /cmp:generated -->
