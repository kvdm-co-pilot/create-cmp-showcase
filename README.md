...
[![Evidence L1 — desktop](https://img.shields.io/badge/evidence-L1_desktop-42A5F5)](https://github.com/kvdm-co-pilot/create-cmp) — the verify lane passed at `0322ffa` on 2026-09-03 at rung **L1 · desktop**. Earned by: `specCoverage`, `approvals`, `componentStories`, `reachability`, `archDoc`, `schemaHistory`, `build`, `unitTests`, `conformance`, `goldenTrees`, `a11y`, `releaseBuild`. The tree had 6 uncommitted files at attestation, so this describes that run, not that commit. The rung describes that run; it says nothing about changes made since.
<!-- /cmp:generated -->
