...
[![Evidence L1 — desktop](https://img.shields.io/badge/evidence-L1_desktop-42A5F5)](https://github.com/kvdm-co-pilot/create-cmp) — the verify lane passed at `2c1a8eb` on 2026-09-02 at rung **L1 · desktop**. Earned by: `specCoverage`, `approvals`, `componentStories`, `reachability`, `archDoc`, `schemaHistory`, `build`, `releaseBuild`, `unitTests`, `conformance`, `goldenTrees`, `a11y`. The tree had 72 uncommitted files at attestation, so this describes that run, not that commit. The rung describes that run; it says nothing about changes made since.
<!-- /cmp:generated -->
