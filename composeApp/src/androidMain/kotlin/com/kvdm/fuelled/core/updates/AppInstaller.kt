...
actual class AppInstaller actual constructor(context: Any?) : InstallCapability {
    ...
    /**
     * This build's own versionCode, read from the package manager rather than BuildConfig, so
     * it is the INSTALLED app's number and not whatever was compiled into a stale constant.
     */
    override val installedVersionCode: Long
        get() = context.packageManager.getPackageInfo(context.packageName, 0).let { info ->
