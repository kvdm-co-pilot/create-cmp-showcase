 ...
 *
 * Six meals at their slot times plus six waters at the derived midpoints — minus the meal slots
 * already ticked done today, whose reminders are cancelled because a meal already eaten is
 * never announced. Water is deliberately unaffected by a meal tick: they are separate rhythms,
 * and ticking lunch says nothing about whether you drank.
 *
...
fun remindersFor(
    ...
    val meals = MealSlot.entries
        ...
        .map { MealReminder(ReminderTarget.Meal(it), times[it], mode) }
