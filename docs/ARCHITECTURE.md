...
- `presentation/` — commonMain: `App.kt`, `brand/FuelledLogo.kt`, `components/AppBottomBar.kt`, `components/AppButton.kt`, `components/AppHeader.kt`, `components/AppIconButton.kt`, `components/BaseScreen.kt`, `components/ContentStateContainer.kt`, `components/ContentUiState.kt`, `components/EmptyState.kt`, `components/ErrorState.kt`, `components/ListItemCard.kt`, `components/PlaceholderScreen.kt`, `components/ProgressRing.kt`, `components/ScreenColumn.kt`, `components/Shimmer.kt`, `components/StatBar.kt`, `components/StatTile.kt`, `components/Tag.kt`, `components/TestTagAutomation.kt`, `foods/FoodDetailScreen.kt`, `foods/FoodDetailViewModel.kt`, `foods/FoodEditorScreen.kt`, `foods/FoodEditorViewModel.kt`, `foods/FoodsScreen.kt`, `foods/FoodsViewModel.kt`, `meal-plan/MealPlanDayScreen.kt`, `meal-plan/MealPlanRoute.kt`, `meal-plan/MealPlanViewModel.kt`, `meal-plan/MealTimesRoute.kt`, `meal-plan/MealTimesScreen.kt`, `meal-plan/MealTimesViewModel.kt`, `meal/MealTrayScreen.kt`, `meal/MealTrayViewModel.kt`, `navigation/AppNavHost.kt`, `navigation/AppShell.kt`, `navigation/AppTab.kt`, `navigation/NavInspectionHook.kt`, `navigation/Screen.kt`, `onboarding/OnboardingScreen.kt`, `onboarding/OnboardingViewModel.kt`, `profile/ProfileScreen.kt`, `profile/ProfileViewModel.kt`, `supplements/SupplementsScreen.kt`, `supplements/SupplementsViewModel.kt`, `theme/DesignToken.kt`, `theme/Shape.kt`, `theme/Theme.kt`, `theme/Tokens.kt`, `theme/Typography.kt`, `today/TodayHighlights.kt`, `today/TodayScreen.kt`, `today/TodayViewModel.kt`, `week/WeekReviewScreen.kt`, `week/WeekReviewViewModel.kt`; androidMain: `components/TestTagAutomation.android.kt`; iosMain: `components/TestTagAutomation.ios.kt`; desktopMain: `components/TestTagAutomation.desktop.kt`
- `domain/` — commonMain: `model/AppState.kt`, `model/DeletedEntry.kt`, `model/DomainError.kt`, `model/Food.kt`, `model/Meal.kt`, `model/MealPlan.kt`, `model/MealReminder.kt`, `model/PlanDay.kt`, `model/Profile.kt`, `model/Supplement.kt`, `model/Today.kt`, `model/WeekReview.kt`, `notification/ReminderDelivery.kt`, `notification/ReminderScheduler.kt`, `repository/AppStateRepository.kt`, `repository/FoodRepository.kt`, `repository/MealPlanRepository.kt`, `repository/ProfileRepository.kt`, `repository/SupplementRepository.kt`, `repository/TodayRepository.kt`, `result/AppResult.kt`, `usecase/AddLogEntriesUseCase.kt`, `usecase/AppStateUseCases.kt`, `usecase/ArmMealRemindersUseCase.kt`, `usecase/CatalogUseCases.kt`, `usecase/CopyDayForwardUseCase.kt`, `usecase/DeleteLogEntryUseCase.kt`, `usecase/EntryEditUseCases.kt`, `usecase/GetFoodsUseCase.kt`, `usecase/GetFoodUseCase.kt`, `usecase/GetMealTimesUseCase.kt`, `usecase/GetPlanDayUseCase.kt`, `usecase/GetProfileUseCase.kt`, `usecase/GetSupplementStackUseCase.kt`, `usecase/GetTodaySummaryUseCase.kt`, `usecase/GetWeekReviewUseCase.kt`, `usecase/MarkEntryLoggedUseCase.kt`, `usecase/SearchFoodsUseCase.kt`, `usecase/SetMealTimeUseCase.kt`, `usecase/SetSlotDoneUseCase.kt`, `usecase/SetSupplementTakenUseCase.kt`, `usecase/SetWaterDoneUseCase.kt`, `usecase/UpdateGoalsUseCase.kt`, `usecase/UpdateProfileNameUseCase.kt`
- `data/` — commonMain: `AppResultCatching.kt`, `local/AppDatabase.kt`, `local/AppStateEntity.kt`, `local/DatabaseBuilder.kt`, `local/FoodDao.kt`, `local/FoodEntity.kt`, `local/MealPlanDao.kt`, `local/MealPlanEntity.kt`, `local/ProfileDao.kt`, `local/ProfileEntity.kt`, `local/SupplementDao.kt`, `local/SupplementEntity.kt`, `local/TodayDao.kt`, `local/TodayEntity.kt`, `remote/AppStateRepositoryImpl.kt`, `remote/FirebaseConfig.kt`, `remote/FoodRepositoryImpl.kt`, `remote/MealPlanRepositoryImpl.kt`, `remote/ProfileRepositoryImpl.kt`, `remote/SupplementRepositoryImpl.kt`, `remote/TodayRepositoryImpl.kt`; androidMain: `local/DatabaseBuilder.android.kt`; iosMain: `local/DatabaseBuilder.ios.kt`; desktopMain: `local/DatabaseBuilder.desktop.kt`
