...
- `presentation/` — commonMain: `app-updates/UpdateScreen.kt`, `app-updates/UpdateViewModel.kt`, `App.kt`, `brand/BrandMark.kt`, `brand/FuelledLogo.kt`, `builder/MealBuilderScreen.kt`, `builder/MealBuilderViewModel.kt`, `components/AppBottomBar.kt`, `components/AppButton.kt`, `components/AppHeader.kt`, `components/AppIconButton.kt`, `components/BaseScreen.kt`, `components/ContentStateContainer.kt`, `components/ContentUiState.kt`, `components/EmptyState.kt`, `components/ErrorState.kt`, `components/ListItemCard.kt`, `components/PlaceholderScreen.kt`, `components/ProgressRing.kt`, `components/ScreenColumn.kt`, `components/Shimmer.kt`, `components/StatBar.kt`, `components/StatTile.kt`, `components/Tag.kt`, `components/TestTagAutomation.kt`, `foods/FoodDetailScreen.kt`, `foods/FoodDetailViewModel.kt`, `foods/FoodEditorScreen.kt`, `foods/FoodEditorViewModel.kt`, `foods/FoodsScreen.kt`, `foods/FoodsViewModel.kt`, `meal-plan/MealPlanDayScreen.kt`, `meal-plan/MealPlanRoute.kt`, `meal-plan/MealPlanViewModel.kt`, `meal-plan/MealTimesRoute.kt`, `meal-plan/MealTimesScreen.kt`, `meal-plan/MealTimesViewModel.kt`, `meal/MealTrayScreen.kt`, `meal/MealTrayViewModel.kt`, `navigation/AppNavHost.kt`, `navigation/AppShell.kt`, `navigation/AppTab.kt`, `navigation/NavInspectionHook.kt`, `navigation/Screen.kt`, `onboarding/OnboardingScreen.kt`, `onboarding/OnboardingViewModel.kt`, `profile/ProfileScreen.kt`, `profile/ProfileViewModel.kt`, `progress/ProgressScreen.kt`, `progress/ProgressViewModel.kt`, `settings/SettingsScreen.kt`, `settings/SettingsViewModel.kt`, `supplements/SupplementsScreen.kt`, `supplements/SupplementsViewModel.kt`, `theme/DesignToken.kt`, `theme/Shape.kt`, `theme/Theme.kt`, `theme/Tokens.kt`, `theme/Typography.kt`, `today/TodayHighlights.kt`, `today/TodayScreen.kt`, `today/TodayViewModel.kt`, `workout/WorkoutCard.kt`, `workouts/WorkoutWeekScreen.kt`, `workouts/WorkoutWeekViewModel.kt`; androidMain: `components/TestTagAutomation.android.kt`; iosMain: `components/TestTagAutomation.ios.kt`; desktopMain: `components/TestTagAutomation.desktop.kt`
