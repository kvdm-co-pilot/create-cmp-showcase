...
- `core/` — commonMain: `connectivity/NetworkMonitor.kt`, `format/Format.kt`, `time/LogicalDay.kt`; androidMain: `connectivity/NetworkMonitor.kt`; iosMain: `connectivity/NetworkMonitor.kt`; desktopMain: `connectivity/NetworkMonitor.desktop.kt`
