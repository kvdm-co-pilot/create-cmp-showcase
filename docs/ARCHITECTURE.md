...
| `AppInstaller` | `core/updates/AppInstaller.kt` | `core/updates/AppInstaller.kt` | `core/updates/AppInstaller.kt` | `core/updates/AppInstaller.desktop.kt` |
...
| `platformReducedMotion()` | `presentation/theme/PlatformMotion.kt` | `presentation/theme/PlatformMotion.android.kt` | `presentation/theme/PlatformMotion.ios.kt` | `presentation/theme/PlatformMotion.desktop.kt` |
<!-- /cmp:generated -->
...
- `presentation/` — commonMain: `app-updates/UpdateScreen.kt`, `app-updates/UpdateViewModel.kt`, `App.kt`, `brand/BrandMark.kt`, `brand/FuelledLogo.kt`, `builder/MealBuilderScreen.kt`, `builder/MealBuilderViewModel.kt`, `components/AnimatedNumber.kt`, `components/AppBottomBar.kt`, `components/AppButton.kt`, `components/AppHeader.kt`, `components/AppIconButton.kt`, `components/BaseScreen.kt`, `components/ContentStateContainer.kt`, `components/ContentUiState.kt`, `components/EmptyState.kt`, `components/ErrorState.kt`, `components/ListItemCard.kt`, `components/Motion.kt`, `components/PlaceholderScreen.kt`, `components/ProgressRing.kt`, `components/ScreenColumn.kt`, `components/Shimmer.kt`, `components/StatBar.kt`, `components/StatTile.kt`, `components/Tag.kt`, `components/TestTagAutomation.kt`, `components/TickButton.kt`, `foods/FoodDetailScreen.kt`, `foods/FoodDetailViewModel.kt`, `foods/FoodEditorScreen.kt`, `foods/FoodEditorViewModel.kt`, `foods/FoodsScreen.kt`, `foods/FoodsViewModel.kt`, `meal-plan/MealPlanDayScreen.kt`, `meal-plan/MealPlanRoute.kt`, `meal-plan/MealPlanViewModel.kt`, `meal-plan/MealTimesRoute.kt`, `meal-plan/MealTimesScreen.kt`, `meal-plan/MealTimesViewModel.kt`, `meal/MealTrayScreen.kt`, `meal/MealTrayViewModel.kt`, `motion/IntroScreen.kt`, `navigation/AppNavHost.kt`, `navigation/AppShell.kt`, `navigation/AppTab.kt`, `navigation/NavInspectionHook.kt`, `navigation/Screen.kt`, `onboarding/OnboardingScreen.kt`, `onboarding/OnboardingViewModel.kt`, `profile/ProfileScreen.kt`, `profile/ProfileViewModel.kt`, `progress/ProgressScreen.kt`, `progress/ProgressViewModel.kt`, `settings/SettingsScreen.kt`, `settings/SettingsViewModel.kt`, `supplements/SupplementsScreen.kt`, `supplements/SupplementsViewModel.kt`, `theme/DesignToken.kt`, `theme/PlatformMotion.kt`, `theme/Shape.kt`, `theme/Theme.kt`, `theme/Tokens.kt`, `theme/Typography.kt`, `today/GoalBloom.kt`, `today/TodayHighlights.kt`, `today/TodayScreen.kt`, `today/TodayViewModel.kt`, `workout/WorkoutCard.kt`, `workouts/WorkoutWeekScreen.kt`, `workouts/WorkoutWeekViewModel.kt`; androidMain: `components/TestTagAutomation.android.kt`, `theme/PlatformMotion.android.kt`; iosMain: `components/TestTagAutomation.ios.kt`, `theme/PlatformMotion.ios.kt`; desktopMain: `components/TestTagAutomation.desktop.kt`, `theme/PlatformMotion.desktop.kt`
- `domain/` — commonMain: `model/AppRelease.kt`, `model/AppState.kt`, `model/DatedGoal.kt`, `model/DeletedEntry.kt`, `model/DomainError.kt`, `model/Food.kt`, `model/History.kt`, `model/Meal.kt`, `model/MealPlan.kt`, `model/MealPreset.kt`, `model/MealReminder.kt`, `model/PlanDay.kt`, `model/Profile.kt`, `model/SemVer.kt`, `model/Supplement.kt`, `model/Today.kt`, `model/Units.kt`, `model/WeekReview.kt`, `model/Weight.kt`, `model/Workout.kt`, `notification/ReminderDelivery.kt`, `notification/ReminderScheduler.kt`, `repository/AppStateRepository.kt`, `repository/FoodRepository.kt`, `repository/MealPlanRepository.kt`, `repository/ProfileRepository.kt`, `repository/SupplementRepository.kt`, `repository/TodayRepository.kt`, `repository/UpdateRepository.kt`, `repository/WeightRepository.kt`, `repository/WorkoutRepository.kt`, `result/AppResult.kt`, `usecase/AddLogEntriesUseCase.kt`, `usecase/AppStateUseCases.kt`, `usecase/ArmMealRemindersUseCase.kt`, `usecase/CatalogUseCases.kt`, `usecase/CheckForUpdateUseCase.kt`, `usecase/CopyDayForwardUseCase.kt`, `usecase/DeleteLogEntryUseCase.kt`, `usecase/EntryEditUseCases.kt`, `usecase/GetFoodsUseCase.kt`, `usecase/GetFoodUseCase.kt`, `usecase/GetHistoryUseCase.kt`, `usecase/GetMealTimesUseCase.kt`, `usecase/GetPlanDayUseCase.kt`, `usecase/GetProfileUseCase.kt`, `usecase/GetSupplementStackUseCase.kt`, `usecase/GetTodaySummaryUseCase.kt`, `usecase/MarkEntryLoggedUseCase.kt`, `usecase/PlanMealUseCase.kt`, `usecase/ReminderStillWantedUseCase.kt`, `usecase/RequestNotificationPermissionUseCase.kt`, `usecase/SearchFoodsUseCase.kt`, `usecase/SetMealTimeUseCase.kt`, `usecase/SetSlotDoneUseCase.kt`, `usecase/SetSupplementTakenUseCase.kt`, `usecase/SetWaterDoneUseCase.kt`, `usecase/SupplementEditUseCases.kt`, `usecase/TomorrowUnplannedUseCase.kt`, `usecase/UpdateGoalsUseCase.kt`, `usecase/UpdateProfileNameUseCase.kt`, `usecase/WeightUseCases.kt`
- `data/` — commonMain: `AppResultCatching.kt`, `local/AppDatabase.kt`, `local/AppStateEntity.kt`, `local/DatabaseBuilder.kt`, `local/FoodDao.kt`, `local/FoodEntity.kt`, `local/MealPlanDao.kt`, `local/MealPlanEntity.kt`, `local/ProfileDao.kt`, `local/ProfileEntity.kt`, `local/SupplementDao.kt`, `local/SupplementEntity.kt`, `local/TodayDao.kt`, `local/TodayEntity.kt`, `local/WeightEntity.kt`, `local/WorkoutEntity.kt`, `remote/AppStateRepositoryImpl.kt`, `remote/FirebaseConfig.kt`, `remote/FoodRepositoryImpl.kt`, `remote/MealPlanRepositoryImpl.kt`, `remote/ProfileRepositoryImpl.kt`, `remote/SupplementRepositoryImpl.kt`, `remote/TodayRepositoryImpl.kt`, `remote/UpdateRepositoryImpl.kt`, `remote/WeightRepositoryImpl.kt`, `remote/WorkoutRepositoryImpl.kt`; androidMain: `local/DatabaseBuilder.android.kt`; iosMain: `local/DatabaseBuilder.ios.kt`; desktopMain: `local/DatabaseBuilder.desktop.kt`
- `core/` — commonMain: `connectivity/NetworkMonitor.kt`, `format/Format.kt`, `time/IsoDate.kt`, `time/LogicalDay.kt`, `time/SystemTime.kt`, `time/TimeSignal.kt`, `updates/AppInstaller.kt`; androidMain: `connectivity/NetworkMonitor.kt`, `updates/AppInstaller.kt`; iosMain: `connectivity/NetworkMonitor.kt`, `updates/AppInstaller.kt`; desktopMain: `connectivity/NetworkMonitor.desktop.kt`, `updates/AppInstaller.desktop.kt`
...
3. **Navigate + process death.** `AppNavHost` (single-Activity/single-`ComposeUIViewController`)
   owns the back stack; each screen's `ViewModel` (scoped via an explicit `viewModel { }` factory in Koin (ARCH-14)) survives
