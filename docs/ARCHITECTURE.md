...
- `presentation/` — commonMain: `App.kt`, `brand/FuelledLogo.kt`, `components/AppBottomBar.kt`, `components/AppButton.kt`, `components/AppHeader.kt`, `components/AppIconButton.kt`, `components/BaseScreen.kt`, `components/ContentStateContainer.kt`, `components/ContentUiState.kt`, `components/EmptyState.kt`, `components/ErrorState.kt`, `components/ListItemCard.kt`, `components/PlaceholderScreen.kt`, `components/ProgressRing.kt`, `components/ScreenColumn.kt`, `components/Shimmer.kt`, `components/StatBar.kt`, `components/StatTile.kt`, `components/Tag.kt`, `components/TestTagAutomation.kt`, `foods/FoodDetailScreen.kt`, `foods/FoodDetailViewModel.kt`, `foods/FoodsScreen.kt`, `foods/FoodsViewModel.kt`, `meal/MealTrayScreen.kt`, `meal/MealTrayViewModel.kt`, `navigation/AppNavHost.kt`, `navigation/AppShell.kt`, `navigation/AppTab.kt`, `navigation/NavInspectionHook.kt`, `navigation/Screen.kt`, `profile/ProfileScreen.kt`, `profile/ProfileViewModel.kt`, `supplements/SupplementsScreen.kt`, `supplements/SupplementsViewModel.kt`, `theme/DesignToken.kt`, `theme/Shape.kt`, `theme/Theme.kt`, `theme/Tokens.kt`, `theme/Typography.kt`, `today/TodayScreen.kt`, `today/TodayViewModel.kt`; androidMain: `components/TestTagAutomation.android.kt`; iosMain: `components/TestTagAutomation.ios.kt`; desktopMain: `components/TestTagAutomation.desktop.kt`
- `domain/` — commonMain: `model/DomainError.kt`, `model/Food.kt`, `model/Meal.kt`, `model/Profile.kt`, `model/Supplement.kt`, `model/Today.kt`, `repository/FoodRepository.kt`, `repository/ProfileRepository.kt`, `repository/SupplementRepository.kt`, `repository/TodayRepository.kt`, `result/AppResult.kt`, `usecase/AddLogEntriesUseCase.kt`, `usecase/DeleteLogEntryUseCase.kt`, `usecase/GetFoodsUseCase.kt`, `usecase/GetFoodUseCase.kt`, `usecase/GetProfileUseCase.kt`, `usecase/GetSupplementStackUseCase.kt`, `usecase/GetTodaySummaryUseCase.kt`, `usecase/MarkEntryLoggedUseCase.kt`, `usecase/SearchFoodsUseCase.kt`, `usecase/SetSupplementTakenUseCase.kt`
- `data/` — commonMain: `AppResultCatching.kt`, `local/AppDatabase.kt`, `local/DatabaseBuilder.kt`, `local/FoodDao.kt`, `local/FoodEntity.kt`, `local/ProfileDao.kt`, `local/ProfileEntity.kt`, `local/SupplementDao.kt`, `local/SupplementEntity.kt`, `local/TodayDao.kt`, `local/TodayEntity.kt`, `remote/FirebaseConfig.kt`, `remote/FoodRepositoryImpl.kt`, `remote/ProfileRepositoryImpl.kt`, `remote/SupplementRepositoryImpl.kt`, `remote/TodayRepositoryImpl.kt`; androidMain: `local/DatabaseBuilder.android.kt`; iosMain: `local/DatabaseBuilder.ios.kt`; desktopMain: `local/DatabaseBuilder.desktop.kt`
